		...
		if (Location == "Middle") {
			if (Pathid = "??") {
				...
				if (m_timer.get() > 0) { // moves robot forward and gribs cube
					if (m_timer.get() < 3) {
						m_ControlMethods.Forwards();
						m_ControlMethods.Closeclaw();
					}
				...
				else if (m_timer.get() > 3.4) { // moves robot forward
					if (m_timer.get() < 5.4) {
						m_ControlMethods.Forwards();
					}
				}
				...
				else if (m_timer.get() > 5.8) { // moves robot forward
					if (m_timer.get() < 8) {
						m_ControlMethods.Forwards();
					}
				}
				...
				else if (m_timer.get() > 8.4) { // moves robot forward
					if (m_timer.get() < 10) {
						m_ControlMethods.Forwards();
					}
				}
				...
				else if (m_timer.get() > 10.4) { // moves robot forward to switch and raises arm
					if (m_timer.get() < 11) {
						m_ControlMethods.Forwards();
						m_ControlMethods.Raisearm();
					}
